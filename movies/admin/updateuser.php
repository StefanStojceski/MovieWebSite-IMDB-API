...
<body>
    <nav class="navbar navbar-expand-sm bg-secondary navbar-dark fixed-top ">
        ...
        <ul class="navbar-nav ">
            ...
            <li class="nav-item ">
                <a class="nav-link" href="moviesrequest.php">User Feedback</a>
            </li>
    ...
    <header>
        ...
        <center><h3 style="margin-bottom:50px;"><span style="font-weight:bold; color: #22A7F0">Update User Data</span></h3></center>
            <form action="" method="post">
                <div class="row">
                    ...
                    <div class="col-md-6 box1">
                        ...
                        <input type="text" name="password" class="input" value="<?php echo md5($row['Pass']);?>" required><br>
