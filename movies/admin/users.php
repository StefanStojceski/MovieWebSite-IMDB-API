        ...
        <form action="" method="post">
            <div class="row">
                <div class="col-md-10 box1">
                    <h3 style="margin-bottom:50px;"><span style="font-weight:bold; color: #22A7F0">Users List </span>(<?php echo $total ?>)</h3>
                    <?php 
                    echo $list;
                    ?>
                    <a href="#popup2" class="btn btn-primary"> Add new Account</a>
                </div>
            </div>   
        </form>
    </div>
