        ...
        // output data of each row
         ...
         while($row = $result->fetch_assoc()) {
            ...
            <div class="col-md-2 box5">
                <a href="../controller/delete.php?id='.$row["RequestId"].'" class="btn btn-primary"> Confirm</a>
            </div>
        </div>            
            ';
        }
...
<body>
    <nav class="navbar navbar-expand-sm bg-secondary navbar-dark fixed-top ">
        ...
        <ul class="navbar-nav ">
            ...
            <li class="nav-item ">
                <a class="nav-link active" href="#">User Feedback</a>
            </li>
        ...
        <form action="" method="post">
            <div class="row">
                <div class="col-md-8 box1">
                    <h3 style="margin-bottom:50px;"><span style="font-weight:bold; color: #22A7F0">Movies feedback Pending</span></h3>
                    <?php 
                    echo $list;
                    ?>
                </div>
